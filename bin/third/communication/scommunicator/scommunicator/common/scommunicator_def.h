...
#	else
#		define	 SCOMMUNICATOR_API		__declspec(dllimport)
#	endif
#else
#	define	 LIB_SCOMMUNICATOR
#endif
...
//通讯管理模块独立宏定义
//INDEPENDENT_MODULE_COMM_SCOMMUNICATOR
#if defined INDEPENDENT_MODULE_COMM_SCOMMUNICATOR
...
#define     COMM_READPROC_INTER           3       //读线程轮循间隔(ms)
#define     COMM_PARSEPROC_INTER          2       //解析线程轮循间隔(ms)
#define     COMM_FORWARDING_INTER         2       //转发线程轮循间隔(ms)
#define     COMM_ACCEPTPROC_INTER         500     //监听线程轮循间隔(ms)
